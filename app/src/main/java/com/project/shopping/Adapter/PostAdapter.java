...
import com.project.shopping.CommentsActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void addList(List<Post> post){
        mList = post;
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder,final int position) {
            ...
            if(post.PostId == null || post.PostId.equals("null")){
                System.out.println(">>>>>>> ERROR POST ID");
                return;
            }
            ...
            String image = post.getUserImage();
            ...
            final String currentUserId = Prevalent.currentOnlineUser.getPhone();


        if(currentUserId == null || currentUserId.equals("null")){
            System.out.println(">>>>>>> ERROR currentUserId");
            return;
        }
            ...
            //like color change
            try{
                System.out.println(">>>>>>>>>>>>>LikeAA "+ postId +" == "+ currentUserId);
                ...
                System.out.println(">>>>>>>>>>>Like "+ e.getMessage());
            }
