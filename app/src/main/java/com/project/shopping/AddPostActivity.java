...
//        setSupportActionBar(postToolbar);
        ...
        currentUserId =  Prevalent.currentOnlineUser.getPhone();
                            ...
                            if (task.isSuccessful()){
                                postRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        postMap.put("time" , System.currentTimeMillis());
                                        postMap.put("userImage", Prevalent.currentOnlineUser.getImage());
                                        postMap.put("userName", Prevalent.currentOnlineUser.getName());
                                        ...
                                        firestore.collection("Posts").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if (task.isSuccessful()){
                                                    ...
                                                    System.out.println(">>>>>>>>>>>RESULT "+task.getResult().getId());
                                                    System.out.println(">>>>>>>>>>>RESULT2 "+postMap);
                                                    mProgressBar.setVisibility(View.INVISIBLE);
