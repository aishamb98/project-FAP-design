...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private ImageView productImage, minusProduct, plusProduct;
//    private ElegantNumberButton numberButton;
    private TextView productPrice,productDescription,productName, counterProduct;
...
//        numberButton = (ElegantNumberButton) findViewById(R.id.number_btn);
        ...
        minusProduct = findViewById(R.id.minus_product);
        plusProduct = findViewById(R.id.plus_product);
        counterProduct = findViewById(R.id.product_counter);

        minusProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                changeProductCounter(false);
            }
        });
    ...
    private void changeProductCounter(boolean plusProduct) {
        int counter = Integer.parseInt(counterProduct.getText().toString());
        if(plusProduct){
            if(counter < 10){
                counter++;
            }
        ...
        counterProduct.setText(String.valueOf(counter));
    }
    ...
    private void addingToCartList() {
        ...
        cartMap.put("quantity", counterProduct.getText().toString());
